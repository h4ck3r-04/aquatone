...
## Project Note
This project is built upon the foundation laid by the open-source project Aquatone created by Michael Henriksen. Aquatone is a powerful tool for visualizing websites across a large number of hosts, and this project aims to enhance and improve its functionality.

The author of this project does not claim any credit for initiating the original Aquatone project. All credit for the original concept, development, and initial implementation belongs to Michael Henriksen. The current efforts are focused solely on making enhancements, adding new features, and improving the overall performance of the original project.

We acknowledge and appreciate the hard work and dedication that went into creating Aquatone and hope to contribute positively to its ongoing development.
